...
x_train = dataset[0:13500, 1:]; x_test = dataset[13500:17000,1:]
y_train = dataset[0:13500, 0]; y_test1 = dataset[13500:17000, 0]
...
a=np.argmax(ans,axis=1)
print(a)
print(collections.Counter(np.equal(a,y_test1)))
utils.reset()
