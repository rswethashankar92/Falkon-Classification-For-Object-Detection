...
def draw_bounding_box_on_image(image,
  ...
  arr = arr[c:d,a:b]
  print(arr.shape)
  cv2.imwrite("file_%count.jpg"%d,arr)  
...
def load_img(path):
  ...
  return img
#downloaded_image_path = download_and_resize_image("/home/kog1cob/Dheeraj/EigenPro2-master/opencv_frame_4.png", 1280, 856, True)
...
detect_img("/home/kog1cob/Dheeraj/EigenPro2-master/opencv_frame_0.png")
